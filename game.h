...
class Game {
    ...
    void filterChecks(Player *currPlayer, Player *enemyPlayer);
    bool executeMove(Player *currPlayer, Player *enemyPlayer, int fromX, int fromY, int toX, int toY);
    bool isStalemate(Player *currPlayer, Player * enemyPlayer);
